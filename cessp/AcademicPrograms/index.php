...
<div class="container-fluid admission-main-container">
    <h2 class="text-center" style="color:#800000;"><strong>Academic Programs</strong></h2> 
    <div class="container-fluid">
        <h3><a href="<?php echo URL;?>AcademicPrograms\mssp.php" style="text-decoration: none;color:#800000;">M.Phil in Solid State physics</a></h3>
        <h3><a href="<?php echo URL;?>AcademicPrograms\mesp.php" style="text-decoration: none;color:#800000;">M.Phil. in Microelectronics Engineering and Semiconductor Physics</a></h3>
        <h3><a href="<?php echo URL;?>AcademicPrograms\mnt.php" style="text-decoration: none;color:#800000;">M.S Nenotechnology</a></h3>
